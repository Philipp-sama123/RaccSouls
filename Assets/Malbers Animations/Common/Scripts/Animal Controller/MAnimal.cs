...
#pragma warning restore 414
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            if (Editor_Tabs1 == 0)
            {
                ...
                if (MainCollider)
                {
                    MDebug.GizmoCapsuleMesh(transform.TransformPoint(MainCollider.center), transform.rotation, MainCollider.height, MainCollider.radius, MainColliderColor, MainCollider.direction, 16, sc);
